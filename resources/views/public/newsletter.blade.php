...
<link rel="shortcut icon" href="https://wesr.unep.org/sites/default/files/MicrosoftTeams-image%20%283%29_0.png" type="image/png" />
...
<nav class="bg-white border-gray-200 dark:bg-gray-900">
    ...
    <a href="#" class="flex items-center space-x-3 rtl:space-x-reverse">
        <svg version="1.1" id="Layer_1" class="block h-9 w-auto fill-current text-gray-800 dark:text-gray-200" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 226.77 164.94" style="enable-background:new 0 0 226.77 164.94;" xml:space="preserve">
            <style type="text/css">
                .unep_0 {
                    fill: #009EE2;
                }
            ...
            <g>
                <g>
                    <g>
                        <g>
                            <g>
                                <g>
                                    <path class="unep_0" d="M178.88,57.2c-8.97-2.71-15.5-11.04-15.5-20.89c0-1.78,0.21-3.51,0.61-5.16l14.17,1.82
                                    c0,0,5.44,0.24,5.24,9.87C183.21,52.18,178.88,57.2,178.88,57.2z"></path>
                                    <path class="unep_0" d="M191.55,57.2c8.97-2.71,15.5-11.04,15.5-20.89c0-1.78-0.21-3.51-0.61-5.16l-14.17,1.82
                                ...
                                <g>
                                    <path class="unep_0" d="M193.92,72.65l1.29-0.81c0,0-6.12-8.3-19.82-8.3c-7.01,0-10.64,2.82-15.55,2.82c0,0-2.01,0.24-3.95-0.97
                                    c0,0,2.34,3.38,10.8,3.38c6.2,0,10.64-3.63,14.99-3.63C187.63,65.15,192.06,70.47,193.92,72.65z"></path>
                                </g>
                                <g>
                                    <path class="unep_0" d="M174.9,72.65l-1.29-0.81c0,0,6.12-8.3,19.82-8.3c7.01,0,10.64,2.82,15.55,2.82c0,0,2.01,0.24,3.95-0.97
                                    c0,0-2.34,3.38-10.8,3.38c-6.2,0-10.64-3.63-14.99-3.63C181.19,65.15,176.75,70.47,174.9,72.65z"></path>
                                </g>
                                <path class="unep_0" d="M168.37,62.82c-0.24,0.64-2.86-0.12-4.63,0.4c-1.98,0.59-12.45,1.85-17.04-9.02c0,0,4.35,4.67,7.74,5
                                c3.38,0.32,7.09,1.13,10.23,2.9l0.73,0.16c0,0-0.1-0.32-0.4-0.48c-0.41-0.22-3.67-1.28-5.24-6.45
                                c-0.81-2.66-0.64-4.59-0.97-5.96c0,0,3.55,3.95,5,6.45C165.23,58.31,165.39,61.13,168.37,62.82z"></path>
                                <path class="unep_0" d="M157.7,57.34c-0.26,0.26-0.93-0.16-1.17-0.28c-0.24-0.12-1.98-0.92-4.96-1.97
                                ...
                                <path class="unep_0" d="M150.85,46.99c-0.15,0.15-0.77-0.77-1.25-1.61c-0.48-0.85-3.87-4.47-4.31-5.2
                                ...
                                c0,0,0.28-0.64,0.68-0.97c0,0,0.32,4.63-1.25,8.94c-1.57,4.31-2.09,5.04-1.85,7.37C150.89,46.38,150.93,46.9,150.85,46.99z"></path>
                                ...
                                c0,0-0.48,1.13-0.48,1.37C148.43,34.34,148.19,34.25,148.19,34.25z"></path>
                                ...
                                s-3.63,1.29-5.56,3.79C151.13,21.44,150.49,22.33,150.33,22.33z"></path>
                                <path class="unep_0" d="M158.14,11.57c0,0,0-0.32,0.6-0.89c0.6-0.56,1.21-2.26,2.26-3.83c1.05-1.57,3.42-5.68,9.59-6.65
                                ...
                                <path class="unep_0" d="M168.41,4.89c0,0,0.12-0.32,1.05-0.6c0.93-0.28,0.85-1.17,3.67-2.66c2.82-1.49,5.76-2.18,8.74-0.93
                                ...
                                c0,0-1.81,0.16-2.9,0.16c-1.09,0-3.95-0.28-5.32-0.93c-1.37-0.64-2.94-0.93-3.46-0.81C169.22,5.01,168.58,5.01,168.41,4.89z"></path>
                                ...
                                <path class="unep_0" d="M201.09,63.26c0,0,0.36-0.36,1.57-1.41c1.21-1.05,1.53-2.58,2.86-4.96c1.33-2.38,2.46-4.03,5.16-6.45
                                ...
                                "></path>
                                <path class="unep_0" d="M219.34,46.1c0,0-0.25-0.59-0.04-1.01c0.12-0.24,0.24-2.18-0.48-3.75c-0.72-1.57-2.3-5.92-2.18-8.82
                                ...
                                <path class="unep_0" d="M215.95,11.9c0,0,0.12-0.73-0.4-1.73c-0.52-1.01-0.11-2.13-1.77-4.79c-0.93-1.49-4.15-2.66-4.15-2.66
                                s0.93,1.29,1.53,2.01c0.6,0.73,0.81,1.25,1.01,1.61s1.32,1.44,1.73,2.05c0.08,0.12,0.24,0.44,0.24,0.64s-0.44-0.12-0.56-0.24
                                c-0.12-0.12-2.09-1.61-3.34-1.85c-1.25-0.24-3.63-0.48-4.27-0.81c0,0,2.82,2.54,5.88,3.3C214.9,10.2,215.95,11.9,215.95,11.9z"></path>
                ...
                <path class="unep_0" d="M125.39,71.71h-14.77L81.86,24.53v47.18H67.08V0h14.77l28.81,47.28V0h14.73V71.71z"></path>
                <g>
                    <path class="unep_0" d="M10.66,118.03c-3.1,0-5.63-0.97-7.58-2.91s-2.92-4.53-2.92-7.76v-0.56c0-2.17,0.41-4.1,1.23-5.81
                    ...
                    c-0.7,0.78-1.14,1.88-1.34,3.33h7.86v-0.46c-0.03-1.28-0.37-2.27-1.02-2.97C12.14,100.65,11.22,100.3,10.02,100.3z"></path>
                    <path class="unep_0" d="M28.01,96.06l0.18,2.49c1.51-1.93,3.54-2.89,6.08-2.89c2.24,0,3.91,0.67,5,2.01s1.66,3.35,1.68,6.02v13.94
                    H35.3v-13.8c0-1.22-0.26-2.11-0.78-2.66c-0.52-0.55-1.39-0.83-2.6-0.83c-1.59,0-2.78,0.69-3.58,2.07v15.22h-5.65V96.06H28.01z"></path>
                    <path class="unep_0" d="M53.39,110.59l3.93-14.54h5.9l-7.14,21.58h-5.39l-7.14-21.58h5.9L53.39,110.59z"></path>
                    ...
                    C66.2,92.07,65.91,91.35,65.91,90.47z M71.91,117.63h-5.67V96.06h5.67V117.63z"></path>
                    ...
                    <path class="unep_0" d="M90.07,106.65c0-2.14,0.4-4.05,1.21-5.72c0.81-1.68,1.97-2.97,3.49-3.89c1.52-0.92,3.28-1.38,5.29-1.38
                    ...
                    c-0.77-1.1-1.85-1.66-3.25-1.66c-1.38,0-2.45,0.55-3.21,1.65C96.1,103.05,95.72,104.75,95.72,107.05z"></path>
                    <path class="unep_0" d="M119.03,96.06l0.18,2.49c1.51-1.93,3.54-2.89,6.08-2.89c2.24,0,3.91,0.67,5,2.01s1.66,3.35,1.68,6.02v13.94
                    h-5.65v-13.8c0-1.22-0.26-2.11-0.78-2.66c-0.52-0.55-1.39-0.83-2.6-0.83c-1.59,0-2.78,0.69-3.58,2.07v15.22h-5.65V96.06H119.03z"></path>
                    <path class="unep_0" d="M141.79,96.06l0.18,2.41c1.5-1.88,3.53-2.81,6.08-2.81c2.72,0,4.59,1.1,5.61,3.29
                    ...
                    c0-1.25-0.24-2.15-0.72-2.71c-0.48-0.56-1.3-0.84-2.46-0.84c-1.6,0-2.76,0.68-3.48,2.03v15.26h-5.65V96.06H141.79z"></path>
                    <path class="unep_0" d="M181.13,118.03c-3.1,0-5.63-0.97-7.58-2.91c-1.95-1.94-2.92-4.53-2.92-7.76v-0.56c0-2.17,0.41-4.1,1.23-5.81
                    ...
                    c-0.7,0.78-1.14,1.88-1.34,3.33h7.86v-0.46c-0.03-1.28-0.37-2.27-1.02-2.97C182.61,100.65,181.69,100.3,180.49,100.3z"></path>
                    <path class="unep_0" d="M198.48,96.06l0.18,2.49c1.51-1.93,3.54-2.89,6.08-2.89c2.24,0,3.91,0.67,5,2.01s1.66,3.35,1.68,6.02v13.94
                    h-5.65v-13.8c0-1.22-0.26-2.11-0.78-2.66c-0.52-0.55-1.39-0.83-2.6-0.83c-1.59,0-2.78,0.69-3.58,2.07v15.22h-5.65V96.06H198.48z"></path>
                ...
                <g>
                    ...
                    <path class="unep_0" d="M36.97,145.46c0-2.14,0.4-4.05,1.21-5.72c0.81-1.68,1.97-2.97,3.49-3.89c1.52-0.92,3.28-1.38,5.29-1.38
                    c2.85,0,5.18,0.89,6.99,2.67c1.81,1.78,2.81,4.2,3.02,7.26l0.04,1.48c0,3.31-0.91,5.97-2.72,7.97c-1.81,2-4.24,3-7.29,3
                    s-5.48-1-7.3-2.99c-1.82-1.99-2.73-4.71-2.73-8.14V145.46z M42.62,145.87c0,2.05,0.38,3.62,1.13,4.7
                    c0.76,1.09,1.84,1.63,3.25,1.63c1.37,0,2.44-0.54,3.21-1.61c0.77-1.07,1.15-2.79,1.15-5.14c0-2.01-0.38-3.57-1.15-4.67
                    c-0.77-1.1-1.85-1.66-3.25-1.66c-1.38,0-2.45,0.55-3.21,1.65C43,141.86,42.62,143.56,42.62,145.87z"></path>
                    ...
                    <path class="unep_0" d="M110.34,156.45c-0.26-0.52-0.45-1.16-0.57-1.93c-1.37,1.56-3.15,2.33-5.34,2.33c-2.07,0-3.79-0.61-5.15-1.83
                    ...
                    c-2.83,0-4.33,1-4.52,2.99l-0.02,0.34c0,0.72,0.25,1.31,0.74,1.77C104.13,152.21,104.81,152.44,105.67,152.44z"></path>
                    <path class="unep_0" d="M125.09,134.87l0.18,2.41c1.5-1.88,3.53-2.81,6.08-2.81c2.72,0,4.59,1.1,5.61,3.29
                    c1.48-2.19,3.6-3.29,6.35-3.29c2.29,0,4,0.68,5.12,2.04c1.12,1.36,1.68,3.41,1.68,6.15v13.78h-5.67v-13.76
                    c0-1.22-0.23-2.12-0.7-2.68c-0.47-0.57-1.3-0.85-2.48-0.85c-1.69,0-2.87,0.82-3.52,2.47l0.02,14.82h-5.65v-13.74
                    c0-1.25-0.24-2.15-0.72-2.71c-0.48-0.56-1.3-0.84-2.46-0.84c-1.6,0-2.76,0.68-3.48,2.03v15.26h-5.65v-21.58H125.09z"></path>
                    <path class="unep_0" d="M159.99,134.87l0.18,2.41c1.5-1.88,3.53-2.81,6.08-2.81c2.72,0,4.59,1.1,5.61,3.29
                    c1.48-2.19,3.6-3.29,6.35-3.29c2.29,0,4,0.68,5.12,2.04c1.12,1.36,1.68,3.41,1.68,6.15v13.78h-5.67v-13.76
                    c0-1.22-0.23-2.12-0.7-2.68c-0.47-0.57-1.3-0.85-2.48-0.85c-1.69,0-2.87,0.82-3.52,2.47l0.02,14.82h-5.65v-13.74
                    c0-1.25-0.24-2.15-0.72-2.71c-0.48-0.56-1.3-0.84-2.46-0.84c-1.6,0-2.76,0.68-3.48,2.03v15.26h-5.65v-21.58H159.99z"></path>
                    <path class="unep_0" d="M199.33,156.84c-3.1,0-5.63-0.97-7.58-2.91c-1.95-1.94-2.92-4.53-2.92-7.76v-0.56c0-2.17,0.41-4.1,1.23-5.81
                    ...
                    c-0.7,0.78-1.14,1.88-1.34,3.33h7.86v-0.46c-0.03-1.28-0.37-2.27-1.02-2.97C200.81,139.47,199.89,139.12,198.69,139.12z"></path>
                </g>
            </g>
        </svg>
    </a>
    <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
        ...
        <button type="button" href="#" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Subscribe Now</button>
        </a>
        @endif
...
<div class="content">
    <div class="embed-container" id="my-pdf"></div>
</div>



<script src="https://unpkg.com/pdfobject@2.3.0/pdfobject.min.js"></script>
<script>PDFObject.embed("http://localhost/ewadalertapp<?=$url?>", "#my-pdf");</script>
...
<script>
   ...
   var userId = "{{$uuid}}";
    ...
    gtag('event', 'newsletter_'+fileId, {
      'app_name': 'EWAD - Newsletter APP',
      'screen_name': 'Public Newsletter',
      'newsletter_file_id': fileId,
      'user_uuid': userId
    });
  </script>
</body>
